        ...
        <div className="grid lg:grid-cols-12 gap-5">
          <Reveal className="lg:col-span-7">
            <div className="bento bento-sand p-10 sm:p-12 h-full">
              ...
              <a href="tel:+18887254937" className="mt-8 btn-primary inline-flex">
        ...
        <div className="bento bento-accent p-10 sm:p-14 relative overflow-hidden">
          ...
          <div className="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 text-white">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="tel:+18887254937" className="inline-flex items-center gap-2 rounded-full glass-dark text-white px-7 py-3.5 font-semibold">
                <Phone className="h-4 w-4" /> (888) 725-4937
              </a>
            </div>
          </div>
        </div>
