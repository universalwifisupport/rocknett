...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get reliable high-speed cable internet, TV, and streaming services from Rocknet, an authorized third-party ISP dealer. Professional installation, 24/7 support, nationwide coverage. Call (888) 478-8407." },
            ...
            <div className="flex flex-col justify-center">
              ...
              <Reveal delay={160}>
                <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  <a href="tel:+18884788407" className="btn-primary w-full sm:w-auto justify-center">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-12 gap-14">
          <div className="lg:col-span-4">
            <Reveal>
              ...
              <a href="tel:+18884788407" className="mt-7 btn-primary inline-flex">
          ...
          <div className="lg:col-span-4">
            <Reveal>
              <div className="lg:sticky lg:top-32">
                ...
                <a href="tel:+18884788407" className="mt-7 inline-flex items-center gap-2 rounded-full bg-ink text-white px-5 py-3 font-semibold hover:bg-primary transition">
            ...
            <div className="relative">
              <Reveal>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <a href="tel:+18884788407" className="inline-flex items-center gap-2 rounded-full bg-white text-ink px-7 py-3.5 font-semibold hover:bg-primary-glow transition">
