...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Rocknet — Call (888) 478-8407" },
      { name: "description", content: "Get in touch with Rocknet. Send a message, request a callback, or call (888) 478-8407 for service inquiries." },
        ...
        <div className="grid lg:grid-cols-12 gap-5">
          ...
          <Reveal className="lg:col-span-5">
            <div className="bento bento-ink p-8 sm:p-10 h-full relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <a href="tel:+18884788407" className="block mt-2 font-display font-extrabold text-4xl sm:text-5xl text-white hover:text-primary-glow transition">
                  (888) 478-8407
                </a>
                ...
                <a href="tel:+18884788407" className="mt-7 inline-flex items-center gap-2 rounded-full bg-white text-ink px-6 py-3 font-semibold hover:bg-primary-glow transition">
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4 lg:gap-5">
            {[
              ...
              { icon: Phone, t: "Phone", v: "(888) 478-8407", href: "tel:+18884788407", sub: "Call anytime during hours" },
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <Reveal delay={150}>
              <div className="bento p-7">
                ...
                <a href="tel:+18884788407" className="mt-5 btn-primary w-full"><Phone className="h-4 w-4" /> (888) 478-8407</a>
              </div>
            </Reveal>
          </div>
        </div>
