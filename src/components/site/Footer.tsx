        ...
        <div className="relative overflow-hidden rounded-t-[2.5rem] bg-ink text-white">
          ...
          <div className="relative grid lg:grid-cols-12 gap-10 p-10 sm:p-14">
            ...
            <div className="lg:col-span-5">
              ...
              <a href="tel:xxx-xxx-xxxx" className="mt-8 inline-flex items-center gap-3 rounded-full bg-white text-ink px-6 py-3 font-semibold hover:bg-primary-glow transition">
                <Phone className="h-4 w-4 text-primary" /> xxx-xxx-xxxx
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <ul className="space-y-4 text-sm">
                  <li className="flex items-start gap-3 text-white/75">
                    ...
                    <a href="tel:xxx-xxx-xxxx" className="hover:text-white">xxx-xxx-xxxx</a>
                  </li>
                  <li className="flex items-start gap-3 text-white/75">
