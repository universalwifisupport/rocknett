...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      ...
      <div className="bg-ink text-white/90 text-[11px] sm:text-xs">
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-5">
          <nav className={`flex items-center justify-between gap-4 rounded-full px-3 sm:px-4 py-2.5 transition-all ${
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              >
                <Phone className="h-3.5 w-3.5 text-primary" /> xxx-xxx-xxxx
              </a>
              <a
                href="tel:xxx-xxx-xxxx"
          ...
          {open && (
            <div className="lg:hidden mt-3 rounded-3xl border border-border bg-card/95 backdrop-blur-xl p-3 shadow-elegant animate-fade-in">
              ...
              <a href="tel:xxx-xxx-xxxx" className="mt-2 flex items-center justify-center gap-2 rounded-full bg-gradient-primary px-5 py-3 font-semibold text-primary-foreground">
